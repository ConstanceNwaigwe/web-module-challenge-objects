...
function createMenuItem(nameObj, priceObj, categoryObj){
  var foodItem = {name: nameObj, price: priceObj, catergory: categoryObj};
...
*/
createMenuItem('Pasta', 32, 'Dinner');
createMenuItem('Rice', 21, 'Lunch');
...
function getReviewByIndex(ranarray, num) {
  console.log(ranarray[num].name, "gave the restaurant a", ranarray[num].rating, "star review, and their feedback was:", ranarray[num].feedback);
  return (ranarray[num].name, "gave the restaurant a", ranarray[num].rating, "star review, and their feedback was:", ranarray[num].feedback);
}
...
function getLastReview(array1) {
  console.log(array1[array1.length - 1].name, "gave the restaurant a", array1[array1.length - 1].rating, "star review, and their feedback was:", array1[array1.length - 1].feedback);
